...
from lib.curtailment import analyze_one_unit, calculate_curtailment_in_mwh, calculate_notified_generation_in_mwh
...
if __name__ == '__main__':
    ...
    df = fetch_physical_data(start_date = "2022-03-19 13:00", end_date = "2022-03-19 13:30", save_dir=SAVE_DIR)
    df = add_bm_unit_type(df, df_bm_units=df_bm_units)

    df.rename(columns={'timeFrom': 'From Time', 'timeTo': 'To Time', 'levelFrom': 'From Level', 'levelTo': 'To Level'},
    inplace=True)
